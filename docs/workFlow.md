...
- Когда все готово создаем PR в ветку develop
- Проходим кросс-ревью
- Проходим ревью от Яндекса
- Вливаем в ветку develop (через **squash & merge**)
- Оповещаем всех остальных (чтобы они подтянули изменения из develop и сразу порешали merge conflict)
