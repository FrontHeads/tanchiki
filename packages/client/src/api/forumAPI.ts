import { type ForumTopicItem } from '../pages/Forum/ForumSection/ForumTopicList/typings';
...
export const forumAPI = {
  ...
  getTopicById: (topicId: number) => HTTP.get<ForumTopicItem>(API_ENDPOINTS.FORUM.GET_TOPIC_BY_ID(topicId)),
