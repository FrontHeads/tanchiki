...
import { type Entity, type Projectile, type Tank, Explosion, Flag, TankEnemy, TankPlayer, Terrain } from '../entities';
import {
  type Direction,
  type EnemyDestroyedPayload,
  type EntityDynamicSettings,
  type EntitySettings,
  type MapData,
